namespace WEBAPIRESTFULL.Migrations
{
    ...
    public partial class First : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Locacoes", "UsuInc", "dbo.Usuarios");
            DropForeignKey("dbo.Locacoes", "Usuario", "dbo.Usuarios");
            DropForeignKey("dbo.Locacoes", "UsuAlt", "dbo.Usuarios");
            ...
            DropIndex("dbo.Locacoes", new[] { "UsuAlt" });
            DropIndex("dbo.Locacoes", new[] { "UsuInc" });
