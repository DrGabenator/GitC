    ...
    class Program
    {
        static class Tetris
        {
            ...
            static void Main()
            {
                ...
                {
                    //Atualizamos o valor da variável "dateVerify" com a hora e minutos atuais
                ...
                switch (fileira)
                {
                    ...
                    //Em caso de não ser informado uma string válida para nosso menu de opções, ele executa esse cara
